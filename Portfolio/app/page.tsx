          ...
          <div className="flex flex-wrap justify-between">
            ...
            <div className="w-full md:w-2/3">
              ...
              <p className="text-lg mb-3 text-gray-300">
                Hello! I'm Diya, a passionate web developer with a focus on frontend technologies. I specialize in creating responsive and interactive web applications using HTML, CSS, JavaScript, and TypeScript. My goal is to deliver high-quality solutions that enhance user experiences and drive engagement.</p>
              
              <div className="flex flex-col">
                 <p className="text-lg font-medium mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-700 inline-block">Education</p>
              <ul>
              <li className="mb-4"> 
                <span className="text-indigo-400 font-semibold">Govt College of Education, Karachi university,</span> 
                <br /> Bachelor in Education (B.Ed.) Expected Graduation: [2026 year]
                </li>
              <li className="mb-4"> 
                <span className="text-indigo-400 font-semibold">IT in Governor House,</span> 
                <br /> Learn website development and agentic AI
                </li>
              <li className="mb-4"> 
                <span className="text-indigo-400 font-semibold">Govt College Science and Commerce College,</span> 
                <br /> Intermediate in Science (Grade A) [2022 year]
                </li>
              <li className="mb-4">
                <span className="text-indigo-400 font-semibold">The suffah Academy,</span> 
              ...
              <div className="flex flex-col">
                ...
                <ul>
                  <li className="mb-4">
                    <span className="text-indigo-400 font-semibold">Technical Skills</span> 
                    <br /> Windows, creating bootable USB drives, Microsoft Office Suite: PowerPoint, Word, Excel
                  </li>
                  <li className="mb-4">
                    <span className="text-indigo-400 font-semibold">Teaching Skills</span>
                    <br /> Lesson planning, classroom management, Student assessment, and curriculum development
                  </li>
                  <li className="mb-4">
                    <span className="text-indigo-400 font-semibold">Technologies</span>
                    <br /> Proficient in HTML, CSS, and JavaScript/TypeScript, Python
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 mt-6">
            ...
            <div className="relative overflow-hidden rounded-lg transform transition duration-500 hover:scale-105">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-blue-500 to-transparent opacity-0 hover:opacity-100 flex flex-col items-center justify-center text-center text-white p-6 transition-opacity duration-500">
                ...
                <a href="https://github.com/Diya-14/calculator-assignment/" target="_blank" className="mt-4 w-10 h-10 flex items-center justify-center bg-white text-blue-500 rounded-full">
                  &#8599;
                </a>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-lg transform transition duration-500 hover:scale-105">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-blue-500 to-transparent opacity-0 hover:opacity-100 flex flex-col items-center justify-center text-center text-white p-6 transition-opacity duration-500">
                <h3 className="text-2xl font-medium mb-4 text-black">Unit convertor</h3>
                <p className="text-sm">This is the Unit convertor. Made By using Python.</p>
                <a href="https://diya-unit-converter.streamlit.app//" target="_blank" className="mt-4 w-10 h-10 flex items-center justify-center bg-white text-blue-500 rounded-full">
                  &#8599;
                </a>
              </div>
            </div>
     ...
     {/* Contact */}
      ...
      <div id="contact" className="py-20 bg-black text-white">
          ...
          <div className="flex flex-wrap justify-between">
            ...
            <div className="contact-left w-full md:w-1/3 mb-12 md:mb-0">
              ...
              <div className="social-icons flex mt-6">
                <a href="https://github.com/Diya-14" target="_blank" className="text-white mr-4 text-xl px-2 py-2 bg-blue-600 rounded-lg hover:bg-blue-700">
                Github</a>
                <a href="https://www.linkedin.com/in/diya-iqbal-9287a72b9/" target="_blank" className="text-white text-xl px-2 py-2 bg-blue-600 rounded-lg hover:bg-blue-700">
                Linkedin</a>
              </div>
        ...
        <div className="copyright bg-gray-900 text-center py-6 mt-8">
          <p className="text-gray-400 text-sm"> © Diya. Made with {'HTML, CSS, JavaScript'}<span className="text-red-500"></span>{' '}using HTML, CSS, and JavaScript.
          </p>
        </div>
      </div>
